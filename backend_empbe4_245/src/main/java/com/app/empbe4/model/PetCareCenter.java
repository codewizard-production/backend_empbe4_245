...
import com.app.empbe4.converter.DurationConverter;
import com.app.empbe4.converter.UUIDToByteConverter;
import com.app.empbe4.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"empbe4_654\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"empbe4_654\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"empbe4_654\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"empbe4_654\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"empbe4_654\"")
